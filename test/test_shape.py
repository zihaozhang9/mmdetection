...
def show_image(model,imgpath,savepath):
    ...
    show_result(imgpath, result, model.CLASSES,show=False, out_file=savepath)
...
config_file = '../configs/my/mask_rcnn_r50_fpn_1x_shape.py'
checkpoint_file ='../work_dirs/mask_rcnn_r50_fpn_1x_shape/latest.pth'
img_root = '../processdata/shapedata/shapes/train/shapes_train2018/'
save_path = 'outputs_shape'
