...
安装时出现[问题](https://github.com/open-mmlab/mmdetection/issues/1055#issuecomment-533935369)可以先更新[nccl](https://github.com/open-mmlab/mmdetection/issues/1025#issuecomment-532548138).任然有问题，然后更新conda`conda update -n base -c defaults conda` .  <br>
